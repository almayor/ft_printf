...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/10/01 06:02:46 by unite             #+#    #+#             */
/*   Updated: 2020/02/10 11:55:05 by unite            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int			flush(t_list **cache, char **line)
{
	...
	else
	{
		...
		while (cache_link_current)
		{
			ft_strlcat(*line, cache_link_current->content, len + 1);
			cache_link_current = cache_link_current->next;
		}
		ft_lstdel_str(cache);
	}
